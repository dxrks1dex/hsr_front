...
export const PickedCharacters = () => {
  ...
  const fourthPlayerUid = fourthPlayer.uid;

  const firstPlayerFirstCircles = firstPlayer.firstCircleCount;
  const firstPlayerSecondCircles = firstPlayer.secondCircleCount;
  const firstPlayerDeaths = firstPlayer.deathCount;

  const secondPlayerFirstCircles = secondPlayer.firstCircleCount;
  const secondPlayerSecondCircles = secondPlayer.secondCircleCount;
  const secondPlayerDeaths = secondPlayer.deathCount;

  console.log(firstTeamPicked, secondTeamPicked);
...
const StyledPickedContainer = styled.div`
  display: grid;
